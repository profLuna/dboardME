...
muniPM25_80th <- me_blkgrps_sf %>% 
  as.data.frame() %>% 
  filter(percent_rank(PM25_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  group_by(TOWN) %>% 
  summarize(BGs80thPM25 = n())

housePM25_80th <- me_blkgrps_sf %>% 
  as.data.frame() %>% 
  filter(percent_rank(PM25_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  group_by(REP_DIST) %>% 
  summarize(BGs80thPM25 = n())

senatePM25_80th <- me_blkgrps_sf %>% 
  as.data.frame() %>% 
  filter(percent_rank(PM25_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  group_by(SEN_DIST) %>% 
  summarize(BGs80thPM25 = n())
...
muniPTRAF_80th <- me_blkgrps_sf %>% 
  as.data.frame() %>% 
  filter(percent_rank(PTRAF_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  group_by(TOWN) %>% 
  summarize(BGs80thPTRAF = n())

housePTRAF_80th <- me_blkgrps_sf %>% 
  as.data.frame() %>% 
  filter(percent_rank(PTRAF_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  group_by(REP_DIST) %>% 
  summarize(BGs80thPTRAF = n())

senatePTRAF_80th <- me_blkgrps_sf %>% 
  as.data.frame() %>% 
  filter(percent_rank(PTRAF_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  group_by(SEN_DIST) %>% 
  summarize(BGs80thPTRAF = n())
...
# create layer of me_blkgrp_sf for 80th percentile
me_blkgrps_sf_PM25 <- me_blkgrps_sf %>% 
  filter(percent_rank(PM25_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  select(NAME, REP_DIST, SEN_DIST, TOWN, POPSlabel, PM25_19, PM25pctile) %>% 
  ms_simplify(., keep = 0.1, keep_shapes = TRUE)

me_blkgrps_sf_DPM <- me_blkgrps_sf %>% 
  filter(percent_rank(DSLPM_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
  select(NAME, REP_DIST, SEN_DIST, TOWN, POPSlabel, DSLPM_19, DPMpctile) %>% 
  ms_simplify(., keep = 0.1, keep_shapes = TRUE)

me_blkgrps_sf_PTRAF <- me_blkgrps_sf %>% 
  filter(percent_rank(PTRAF_19) >= 0.8 & POPSlabel != "No Pops of Concern") %>% 
...
# # reduce number of variables in me_blkgrps_sf for faster loading
# me_blkgrps_sf <- me_blkgrps_sf %>%
...
Concentrations of hazardous air pollutants and associated risks are highest in the southeast corner of Maine and areas on or near I-95 as far north as Bangor. Limited English speaking households and people of color are by far the most exposed to higher levels of air pollutants and are living in close proximity to high traffic corridors.

These interactive figures identify communities across Maine that are most overburdened and most vulnerable to three transportation-related burdens: PM~2.5~, Diesel Particulate Matter (DPM), and Traffic Volume and Proximity.
...
PopupHouse <- paste0("Maine state House District ", "<b>",house_districts$REP_DIST,"</b>", " has ", "<b>",house_districts$BGs80thPM25,"</b>", " <b>Block Groups</b> with high percentages of priority populations experiencing <b>PM<sub>2.5</sub></b> concentrations at the 80th percentile or higher.", "<br/>",
...
PopupSenate <- paste0("Maine state Senate District ", "<b>",senate_districts$SEN_DIST,"</b>", " has ", "<b>",senate_districts$BGs80thPM25,"</b>", " <b>Block Groups</b> with high percentages of priority populations experiencing <b>PM<sub>2.5</sub></b> concentrations at the 80th percentile or higher.", "<br/>",
...
Popup <- paste0(me_blkgrps_sf_PM25$NAME, "<br/>",
                "<b>State House District:</b> ", me_blkgrps_sf_PM25$REP_DIST, "<br/>",
                  "<b>State Senate District:</b> ", me_blkgrps_sf_PM25$SEN_DIST, "<br/>",
                      "<b>Town:</b> ", me_blkgrps_sf_PM25$TOWN, "<br/>",
                      "<b>PM<sub>2.5</sub> (&mu;g/m<sup>3</sup>):</b> ", round(me_blkgrps_sf_PM25$PM25_19,2), "<br/>",
         "<b>PM<sub>2.5</sub> percentile:</b> ", round(me_blkgrps_sf_PM25$PM25pctile*100,0), "<br/>",
                      "<b>Priority Populations: </b>", me_blkgrps_sf_PM25$POPSlabel)
...
leaflet(width = "100%") %>% 
  ...
  addPolygons(data = me_blkgrps_sf_PM25, 
  ...
  addLegend(title = "Highest PM<sub>2.5</sub> (&mu;g/m<sup>3</sup>)<br>for Priority Populations", 
            pal = palPM25,
            values = round(me_blkgrps_sf_PM25$PM25_19,2),
            position = "bottomleft",
...
palDPM <- colorQuantile(
  palette = "YlOrRd",
  domain = me_blkgrps_sf_DPM$DSLPM_19,
  n = 5)
...
PopupHouse <- paste0("Maine state House District ", "<b>",house_districts$REP_DIST,"</b>", " has ", "<b>",house_districts$BGs80thDPM,"</b>", " <b>Block Groups</b> with high percentages of priority populations experiencing <b>DPM</b> concentrations at the 80th percentile or higher.", "<br/>",
...
PopupSenate <- paste0("Maine state Senate District ", "<b>",senate_districts$SEN_DIST,"</b>", " has ", "<b>",senate_districts$BGs80thDPM,"</b>", " <b>Block Groups</b> with high percentages of priority populations experiencing <b>DPM concentrations at the 80th percentile or higher.", "<br/>",
...
Popup <- paste0(me_blkgrps_sf_DPM$NAME, "<br/>",
                "<b>State House District:</b> ", me_blkgrps_sf_DPM$REP_DIST, "<br/>",
                  "<b>State Senate District:</b> ", me_blkgrps_sf_DPM$SEN_DIST, "<br/>",
                      "<b>Town:</b> ", me_blkgrps_sf_DPM$TOWN, "<br/>",
                      "<b>DPM (&mu;g/m<sup>3</sup>):</b> ", round(me_blkgrps_sf_DPM$DSLPM_19,2), "<br/>",
         "<b>DPM percentile:</b> ", round(me_blkgrps_sf_DPM$DPMpctile*100,0), "<br/>",
                      "<b>Priority Populations: </b>", me_blkgrps_sf_DPM$POPSlabel)
...
leaflet(width = "100%") %>% 
  ...
  addPolygons(data = senate_districts,
              ...
              highlight = highlightOptions(
                ...
                bringToFront = TRUE),
              group = "State Senate Districts") %>% 
  addPolygons(data = me_blkgrps_sf_DPM, 
  ...
  addLegend(title = "Highest Diesel<br>Particulate Matter (&mu;g/m<sup>3</sup>)<br>for Priority Populations", 
            pal = palDPM,
            values = me_blkgrps_sf_DPM$DSLPM_19,
            position = "bottomleft",
            labFormat = function(type, cuts, p) {
              n = length(cuts)
              p = paste0(round(p * 100), '%')
...
palPTRAF <- colorQuantile(
  palette = "YlOrRd",
  domain = me_blkgrps_sf_PTRAF$PTRAF_19,
  n = 5)
...
PopupHouse <- paste0("Maine state House District ", "<b>",house_districts$REP_DIST,"</b>", " has ", "<b>",house_districts$BGs80thPTRAF,"</b>", " <b>Block Groups</b> with high percentages of priority populations experiencing <b>Traffic Proximity and Volume (PTRAF)</b> values at the 80th percentile or higher.", "<br/>",
...
PopupSenate <- paste0("Maine state Senate District ", "<b>",senate_districts$SEN_DIST,"</b>", " has ", "<b>",senate_districts$BGs80thPTRAF,"</b>", " <b>Block Groups</b> with high percentages of priority populations experiencing <b>Traffic Proximity and Volume (PTRAF)</b> values at the 80th percentile or higher.", "<br/>",
...
Popup <- paste0(me_blkgrps_sf_PTRAF$NAME, "<br/>",
                "<b>State House District:</b> ", me_blkgrps_sf_PTRAF$REP_DIST, "<br/>",
                  "<b>State Senate District:</b> ", me_blkgrps_sf_PTRAF$SEN_DIST, "<br/>",
                      "<b>Town:</b> ", me_blkgrps_sf_PTRAF$TOWN, "<br/>",
                      "<b>PTRAF (AADT/Distance(km)):</b> ", formatC(round(me_blkgrps_sf_PTRAF$PTRAF_19,0), big.mark = ",", digits = 5, format = "d"), "<br/>",
         "<b>PTRAF percentile:</b> ", round(me_blkgrps_sf_PTRAF$PTRAFpctile*100,0), "<br/>",
                      "<b>Priority Populations: </b>", me_blkgrps_sf_PTRAF$POPSlabel)
...
leaflet(width = "100%") %>% 
  ...
  addPolygons(data = senate_districts,
              ...
              highlight = highlightOptions(
                ...
                bringToFront = TRUE),
              group = "State Senate Districts") %>% 
  addPolygons(data = me_blkgrps_sf_PTRAF, 
  ...
  addLegend(title = "Highest Traffic<br>Exposure (PTRAF)<br>for Priority Populations", 
            pal = palPTRAF,
            values = me_blkgrps_sf_PTRAF$PTRAF_19,
            position = "bottomleft",
            labFormat = function(type, cuts, p) {
              n = length(cuts)
              p = paste0(round(p * 100), '%')
...
```{r graphPM25, fig.align="center", fig.cap="Population-weighted average exposures to PM2.5 for priority populations in Maine relative to the state average."}
# Load data
load("../DATA/ne_layers.rds")
...
```{r graphDPM, fig.align="center", fig.cap="Population-weighted average exposures to Diesel Particulate Matter (DPM) for priority populations in Maine relative to the state average."}
# # Load data
# load("../DATA/ne_layers.rds")
# 
# # Create data subsets of Maine
...
```{r graphPTRAF, fig.align="center", fig.cap="Population-weighted average exposures to Traffic Proximity and Volume (PTRAF) for priority populations in Maine relative to the state average."}
# # Load data
# load("../DATA/ne_layers.rds")
# 
# # Create data subsets of Maine
...
# Pop Weighted avg of PTRAF for all Groups in Maine relative to state average
PTRAFpopAvg <- me_blkgrp_sf %>% 
  as.data.frame() %>% 
  dplyr::select(totalpopE,
                nhwhitepopE,
                minorityE,
...
exPM25town <- me_towns %>% as.data.frame() %>% filter(pctrank_PM25_19.mean > 95) %>% select(NAME) %>% slice_tail(n = 1) %>% pull()
exPM25 <- me_towns %>% as.data.frame() %>% filter(NAME == exPM25town) %>% select(PM25_19.mean) %>% pull() %>% round(., 3)
exPM25pct <- me_towns %>% as.data.frame() %>% filter(NAME == exPM25town) %>% select(pctrank_PM25_19.mean) %>% pull() %>% round(., 1)
