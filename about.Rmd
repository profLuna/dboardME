...
Evacuation risk was analyzed using the Federal Emergency Management Agency's (FEMA) [National Flood Hazard Layer](https://msc.fema.gov/portal/advanceSearch), and projected hurricane storm surge extents from the [National Weather Service's National Hurricane Center and U.S. Army Corps of Engineers SLOSH modeling](https://www.nhc.noaa.gov/nationalsurge/). 
...
Details on the analyses for Maine for specific burden categories are available in technical reports at the following links:
...
This online application is built with [R version 4.0.3 (R Core Team, 2020)](https://www.r-project.org/) using the [R Markdown](https://rmarkdown.rstudio.com/) package in Rstudio. Charts, tables, and maps use [Highcharts](http://www.highcharts.com/),  [DataTables](https://datatables.net/), and [Leaflet.js](http://leafletjs.com/), respectively, all accessed through their corresponding R packages.  The R code for this online dashboard is available at https://github.com/profLuna/dboardME
